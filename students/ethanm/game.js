...
function autoSubmitQuestion(){if(activePhase==="qualifying"||activePhase==="race"||activePhase==="pit"){const currentItem=activePhase==="qualifying"?qualifyingQuestions[qualifyingIndex]:activePhase==="race"?raceQuestions[raceIndex]:pitQuestions[qualifyingIndex];handleAnswer(-1,activePhase,activePhase==="qualifying"?qualifyingIndex:activePhase==="race"?raceIndex:qualifyingIndex,currentItem);}}
